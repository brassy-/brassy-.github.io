...
import { safariHeader, macOSHeader, noHeader } from './headerStyles';
...
export class ResizableWindow extends React.Component<Props> {
	...
	render() {
		let layout;
		let headerHeight = this.props.style === 'macOS' ? 22 : 0;
		let content;
		...
		return (
			...
			<Frame
				...
				{header(this, this.props.appearance, this.props.style, this.props.title)}
...
function highlightBorder(
	...
	return {
		boxShadow: appearance ? 'inset 0px 0px 0px 1px rgba(255,255,255,0.15)' : null,
		position: 'absolute',
		left: 0,
		top: 0,
		pointerEvents: 'none',
...
function scrollRegion(
	...
	return (
		<Frame
			style={{
				borderRadius: style === 'macOS' ? '0 0 4px 4px' : '6px'
			}}
			left={0}
			top={headerHeight}
			width={width}
...
function header(parent: any, appearance: boolean, style: string, title: string) {
	if (style === 'macOS') {
		return macOSHeader(parent, appearance, title);
	} else if (style === 'Safari') {
		return safariHeader(parent, appearance, title);
	} else if (style === 'None') {
		return noHeader(parent, appearance);
	}
}
